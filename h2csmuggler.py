...
def init():
    ...
    parser.add_argument("--upgrade-only", default=False, action="store_true",
                        help="drop HTTP2-Settings from outgoing Connection header")
    ...
    parser.add_argument("-m", "--max-time", type=float, default=10, help="socket timeout in seconds")
